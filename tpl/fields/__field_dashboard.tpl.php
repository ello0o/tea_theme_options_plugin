                            ...
                            <div class="tea-post-body-content">
                                ...
                                <div class="dashboard-contents-all">
                                    ...
                                    <div class="dashboard-content">
                                        ...
                                        <p><?php _e('The capability_type argument is another catchall argument for several more specific arguments and defaults to post. It allows you to define a custom set of capabilities, which are permissions to edit, create, and read your custom post type', TTO_I18N) ?></p>
