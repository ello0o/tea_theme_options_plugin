...
<div id="<?php echo $id ?>_<?php echo $type ?>_content" class="stuffbox">
    <h3>
    ...
    <div class="inside <?php echo $type ?>">
        ...
        <?php else: ?>
            <?php $multiple ? printf(__('There are no %s found.', TTO_I18N), $type) : printf(__('There is no %s found.', TTO_I18N), $type) ?>
        <?php endif ?>
    </div>
</div>
<!-- /Content <?php echo $type ?> <?php echo $id ?> -->