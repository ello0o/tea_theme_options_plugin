...
?>
<input type="hidden" name="tea_add_contents[<?php echo $num ?>][type]" value="color" />
...
<label class="label-edit-content">
    ...
    <input type="text" name="tea_add_contents[<?php echo $num ?>][std]" value="<?php echo isset($val['std']) ? $val['std'] : '' ?>" class="color-picker" maxlength="7" />
</label>